...
class MeetingSearcher:
    ...
    def search(self, query: str, top_k: int = 10, speaker: str | None = None) -> dict[str, Any]:
        ...
        scores, indices = self._search_vectors(query_vector, candidate_limit)
        ...
        return {"query": query, "top_k": top_k, "results": results, "latency_ms": round((time.perf_counter() - start) * 1000, 2)}
